...
def main(args):
    ...
    source_numpy = cv2.imread(args.source) / 255.0
    target_numpy = cv2.imread(args.target) / 255.0
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--source", type=str, default="", help="path of the source image"
    )
    parser.add_argument(
        "-t", "--target", type=str, default="", help="path of the target image"
    )
