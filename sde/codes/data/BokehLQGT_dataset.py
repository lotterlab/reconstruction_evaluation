...
class BokehLQGTDataset(data.Dataset):
    ...
    def _read_meta_data(self, meta_file_path: str):
        ...
        for line in lines:
            id, src_lens, tgt_lens, disparity = [
                part.strip() for part in line.split(",")
            ]
            meta[id] = (src_lens, tgt_lens, disparity)
        return meta

    def lenstr2tensor(self, lenstr, scale=1.0):
    ...
    def __getitem__(self, index):
        ...
        src_lens = self.lenstr2tensor(src_lens, scale=10.0)
        tgt_lens = self.lenstr2tensor(tgt_lens, scale=10.0)
        disparity = self.lenstr2tensor(disparity, scale=1.0)
