...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--val_freq", type=int, default=1, help="frequency of validation (epochs)"
        )
        parser.add_argument(
            "--val_dataroot", type=str, help="path to validation dataset"
        )
        ...
        parser.add_argument(
            ...
            type=float,
            default=0.2,
            help="alpha for leaky ReLU in generator",
        )
        parser.add_argument(
            "--leaky_relu_alpha_D",
            type=float,
            default=0.2,
            help="alpha for leaky ReLU in discriminator",
        )
        parser.add_argument("--tum", action="store_true", help="perform validation")

        parser.add_argument(
            "--fairness_lambda", type=float, default=10, help="lambda for fairness loss"
        )
